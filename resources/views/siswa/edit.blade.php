    ...
    <form action="{{ route('siswa.update', $siswa->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select name="status_pembayaran" id="status_pembayaran" class="form-control" required>
                ...
                <option value="Sudah Membayar" {{ $siswa->status_pembayaran == 'Sudah Membayar' ? 'selected' : '' }}>Sudah Membayar</option>
                <option value="Belum Membayar" {{ $siswa->status_pembayaran == 'Belum Membayar' ? 'selected' : '' }}>Belum Membayar</option>
            </select>
        </div>
