...
<?php endif; ?>
    ...
    <tr>
        <td>
            <!-- Menambahkan event pada onclick dan event.preventDefault() untuk mencegah reload -->
            <a href="<?php echo e(route('siswa.index', ['tahun_masuk_id' => $tahunMasuk->id])); ?>" onclick="window.location='<?php echo e(route('siswa.index')); ?>'">
    <i class="fas fa-users"></i> <?php echo e($tahunMasuk->tahun); ?>
...
<?php /**PATH C:\xampp\htdocs\magang\resources\views/siswa/datatahunsiswa.blade.php ENDPATH**/ ?>