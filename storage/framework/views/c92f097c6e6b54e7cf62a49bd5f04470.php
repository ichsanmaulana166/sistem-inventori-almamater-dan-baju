...
<body>
    ...
    <form action="<?php echo e(route('barang.store-almamater')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\magang\resources\views/barang/create-almamater.blade.php ENDPATH**/ ?>