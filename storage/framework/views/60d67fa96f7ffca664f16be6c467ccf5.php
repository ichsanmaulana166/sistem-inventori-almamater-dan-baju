...
<?php endif; ?>
    ...
    <div class="content1">
        ...
        <div class="main-content" id="data-tahun-masuk">
            ...
            <div class="actions">
                <div>
    <form method="GET" action="<?php echo e(route('tahun_masuk.index')); ?>" id="filterForm">
        <button type="button" onclick="window.location='<?php echo e(route('tahun_masuk.create')); ?>'">+ Tahun Masuk</button>
        </div>

        <div>
            Show 
            <select name="entries" onchange="document.getElementById('filterForm').submit()">
                <option value="10" <?php echo e(request('entries') == 10 ? 'selected' : ''); ?>>10</option>
        ...
        <div>
            ...
            <input placeholder="Cari Tahun" type="text" id="search" name="search" value="<?php echo e(request('search')); ?>" onkeyup="document.getElementById('filterForm').submit()">
        </div>
    </form>
</div>
                ...
                <table>
                    ...
                    <tbody>
            <?php $__currentLoopData = $tahunMasuks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tahunMasuk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e($index + 1); ?></td>
                <td><?php echo e($tahunMasuk->tahun); ?></td>
                <td>
                    <a href="<?php echo e(route('tahun_masuk.edit', $tahunMasuk->id)); ?>">Edit /</a>
                    <form action="<?php echo e(route('tahun_masuk.destroy', $tahunMasuk->id)); ?>" method="POST" style="display:inline;">
                        <?php echo csrf_field(); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div>
    <?php echo e($tahunMasuks->appends(request()->query())->links()); ?>
...
<?php /**PATH C:\xampp\htdocs\magang\resources\views/tahun_masuk/index.blade.php ENDPATH**/ ?>