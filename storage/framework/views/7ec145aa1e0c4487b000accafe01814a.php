    ...
    <img src="/images/user_icon.png" alt="Logo">
        ...
        <div class="menu">
            ...
            <div class="submenu" id="submenu-laporan">
                <a href="#" onclick="showLaporanPenambahan()"><i><i></i></i>Penambahan</a>
...
<?php endif; ?>
    ...
    <div class="content1">
        ...
        <div class="main-content" id="data-laporan-penambahan">
            <h2>LAPORAN HISTORI PENAMBAHAN ALMAMATER</h2>

            <!-- PENAMBAHAN ALMAMATER -->
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $laporanAlmamater; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $laporan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($index + 1); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($laporan->tanggal)->format('d-m-Y')); ?></td>
                        <td><?php echo e($laporan->penambahan); ?></td>
                        <td><?php echo e($laporan->size); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="4" class="text-center">Tidak ada data penambahan almamater</td>
                    </tr>
                <?php endif; ?>
            </tbody>
                </table>
            ...
            <!-- PENAMBAHAN BAJU -->
            <h2 style="margin-top: 50px;">LAPORAN HISTORI PENAMBAHAN BAJU</h2>
            <div class="table-container">
            <table>
                <thead>
                        <tr>
                    ...
                    <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $laporanBaju; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $laporan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($index + 1); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($laporan->tanggal)->format('d-m-Y')); ?></td>
                        <td><?php echo e($laporan->penambahan); ?></td>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="4" class="text-center">Tidak ada data penambahan baju</td>
                    </tr>
                <?php endif; ?>
            </tbody>
                </table>
...
<?php /**PATH C:\xampp\htdocs\magang\resources\views/barang/laporan-penambahan.blade.php ENDPATH**/ ?>